...
\begin{frame}{DE-PROX vs DU-PROX Across Iterations}
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.86\textwidth]{../Common_Images/deq/deqip_example.jpg}
        \caption*{DU-Prox can break when run beyond its trained depth, while DE-Prox remains stable and accurate at convergence \cite{gilton2021deep}.}
    \end{figure}
\end{frame}
