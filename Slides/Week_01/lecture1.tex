...
\begin{block}{Co-worker, not Pilot}
    All types of AI assistance (LLMs, Copilots) are \textbf{allowed and encouraged}.
\end{block}

\begin{itemize}
    \item \textbf{The Risk}: You are responsible for the output. Hallucinations are common in advanced math/code.
    \item \textbf{The Method}: Do not work in isolation. Discuss AI findings with TAs, instructors, and peers.
    \item \textbf{The Goal}: Learn to use AI as a productivity multiplier, not a solution generator.
\end{itemize}
\end{frame}
...
\begin{enumerate}
    \item \textbf{Formative Assessment (0\%)}
    \begin{itemize}
        \item Released Week 1, Due Week 2.
...
\begin{alertblock}{Coursework 3 (50\%) -- The "Exam" Component}
    \begin{itemize}
        ...
        \item \textbf{Restrictions}: \textbf{NO} Internet access. \textbf{NO} AI assistance.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Stability and regularisation fundamentals.
    \end{itemize}
