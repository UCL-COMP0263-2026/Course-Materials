...
\begin{alertblock}{Coursework 3 (50\%) -- Category 1 Assessment}
    \begin{itemize}
        \item \textbf{Format}: In-person supervised session (Fri, March 27).
        \item \textbf{Duration}: 3 hours.
        \item \textbf{Content}: Mixture of Multiple Choice Questions and Coding Exercises.
        \item \textbf{Restrictions}: \textbf{NO} General internet access. \textbf{NO} AI assistance (Category 1: GenAI tools cannot be used).
