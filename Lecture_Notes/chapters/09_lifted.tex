...
\end{equation*}
we introduce auxiliary variables $\zeta_1,\ldots,\zeta_J$ and define $u=(x,\zeta_1,\ldots,\zeta_J)^\top\in\mathbb{R}^{M+J}$ and $z=(z_1,\ldots,z_J)^\top\in\mathbb{R}^{J}$. Then one convenient choice to frame \eqref{eq:shallownn} as \eqref{eq:unified_architecture} is with
\begin{equation*}
