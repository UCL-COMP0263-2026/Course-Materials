...
\begin{defi}[Bregman Distance \cite{bregman,kiwiel1997proximal}]\normalfont
...
\begin{align*}
\operatorname{prox}_{\tau J}(x) := \argmin_{u \in \mathcal{U}} \left\{ \frac{1}{2}\|u - x\|^2 + \tau J(u) \right\} \, .
\end{align*}
\end{defi}
...
$$ \operatorname{TV}(u) = \sup \left\{ \int_\Omega u(x) \operatorname{div} \varphi(x) \, dx \mid \varphi \in C_c^1(\Omega, \mathbb{R}^2), \|\varphi(x)\|_2 \leq 1 \text{ for all } x \right\} \, . $$
