...
\begin{defi}[Convex Conjugate]\label{def:convex_conjugate}\normalfont
...
\begin{defi}[Proximal Operator]\label{def:prox_operator}\normalfont
...
\begin{exm}[$\ell^1$-Norm and Soft Thresholding]\label{exm:soft_thresholding_ch2}\normalfont
